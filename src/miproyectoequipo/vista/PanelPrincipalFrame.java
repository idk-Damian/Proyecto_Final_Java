...
public class PanelPrincipalFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        panelContenido.add(crearPanelActualizarEmpleado(), "ACT_EMPLEADO");
        panelContenido.add(crearPanelEliminarEmpleado(), "DEL_EMPLEADO");
    ...
    private void mostrarListaEmpleados() {
        ...
        String[] columnas = {"Cédula", "Nombre", "Apellido", "Cargo", "Tipo", "Estado", "Huella"};
        HuellaDAO hDAO = new HuellaDAO();
        ...
        for (int i = 0; i < empleados.size(); i++) {
            ...
            datos[i] = new Object[]{
                ...
                emp.getApellido(),
                emp.getCargo(),
                emp.getTipoContrato().name(),
                emp.isActivo() ? "ACTIVO" : "DESCANSANDO",
